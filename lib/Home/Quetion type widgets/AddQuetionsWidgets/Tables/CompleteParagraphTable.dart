...
class CompleteParagraphTable extends StatefulWidget {
  final String main_category_id;
  final String sub_category_id;
  final String topic_id;
  final String sub_topic_id;
  final List<CompleteParaData> questionList;
  ...
  @override
  _CompleteParagraphTableState createState() => _CompleteParagraphTableState();
}

class _CompleteParagraphTableState extends State<CompleteParagraphTable> {
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: PaginatedDataTable(
                      ...
                      columns: [
                        ...
                        const DataColumn(label: Text("Option E")),
                        const DataColumn(label: Text("Option F")),
...
class QuestionDataSource extends DataTableSource {
  final List<CompleteParaData> questions;
  ...
  DataRow? getRow(int index) {
    ...
    return DataRow(
      ...
      cells: [
        ...
        DataCell(Text(question.optionE.toString()?? "")),
        DataCell(Text(question.optionF.toString()?? "")),
