                  ...
                  child: SingleChildScrollView(
                    ...
                    child: PaginatedDataTable(
                      ...
                      columns: [
                        ...
                        const DataColumn(label: Text("Story Title")),
                        const DataColumn(label: Text("Content")),
                        const DataColumn(label: Text("Highligh Word")),
  ...
  DataRow? getRow(int index) {
    ...
    return DataRow(
      ...
      cells: [
        ...
        DataCell(Text(question.storyTitle ?? "")),
        DataCell(Text(question.content ?? "")),
        DataCell(Text(question.highlightWord.toString()?? "")),
        DataCell(Text(question.points.toString())),
        // DataCell(Text(question.storyImg ?? "")),
        DataCell(
          GestureDetector(
            onTap: () {
            },
