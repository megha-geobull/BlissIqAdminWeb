class UserConversationModel {
  ...
  late final List<UserConversationalData> data;

  UserConversationModel.fromJson(Map<String, dynamic> json){
    status = json['status'];
    message = json['message'];
    data = List.from(json['data']).map((e)=>UserConversationalData.fromJson(e)).toList();
  }
...
class UserConversationalData {
  UserConversationalData({
    required this.id,
  ...
  UserConversationalData.fromJson(Map<String, dynamic> json){
    id = json['_id'];
