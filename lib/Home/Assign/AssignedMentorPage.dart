...
class AssignedMentorPage extends StatefulWidget {
  final String schoolID;
  const AssignedMentorPage({super.key, required this.schoolID});

  @override
  State<AssignedMentorPage> createState() => _AssignedMentorPagePageState();
}

class _AssignedMentorPagePageState extends State<AssignedMentorPage> {
  ...
  void initState() {
    ...
    print("School from mentor page"+widget.schoolID);
  }
                  ...
                  Expanded(
                    child: Scaffold(
                      appBar: isWideScreen
                          ? null
                          : AppBar(
                        title: const Text('Assigned Mentor'),
